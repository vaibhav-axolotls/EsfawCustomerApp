...
class PopularStoreView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<StoreController>(builder: (storeController) {
      _storeList = isFeatured ? storeController.featuredStoreList : isPopular ? storeController.popularStoreList
          : storeController.latestStoreList;
      final count = _storeList;
      print("========");
      print(count.length);
      newsize = size * (count.length);
        ...
        children: [
          ...
          SizedBox(
            ...
            child: _storeList != null ? ListView.builder(
              ...
              itemCount: _storeList.length > count.length ? count.length : _storeList.length,
