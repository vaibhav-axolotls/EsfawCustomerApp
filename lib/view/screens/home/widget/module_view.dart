...
import 'package:sixam_mart/view/screens/home/theme1/home_category_view.dart';
...
import '../theme1/popular_store_view1.dart';
import 'StaticAdBanner.dart';
...
class ModuleView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      BannerView1(isFeatured: true),
      CategoryView1(),

      BestReviewedItemView(),
     // HomeCategoryView(),
      PopularStoreView(isPopular: true, isFeatured: true),
