...
import 'package:sixam_mart/view/screens/home/widget/home_category_pop_up.dart';
...
class HomeCategoryView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<HomeCategoryController>(builder: (homecategoryController) {
      return (homecategoryController.categoryList != null && homecategoryController.categoryList.length == 0) ? SizedBox() : Column(
        children: [
          Padding(
          ...
          Row(
            children: [
              Expanded(
                child: SizedBox(
                  height: 125,
                  child: homecategoryController.categoryList != null ? ListView.builder(
                    controller: _scrollController,
                    itemCount: homecategoryController.categoryList.length > 15 ? 15 : homecategoryController.categoryList.length,
                              ...
                              child: Stack(children: [
                                ClipRRect(
                                  ...
                                  child: CustomImage(
                                    ...
                                    height: 165, width: 165, fit: BoxFit.cover,
                                  ),
                                ),
                                Positioned(bottom: 0, left: 0, right: 0, child: Container(
                                  ...
                                  child: Text(
                                    homecategoryController.categoryList[index].name, maxLines: 1, overflow: TextOverflow.ellipsis,
              ...
              ResponsiveHelper.isMobile(context) ? SizedBox() : homecategoryController.categoryList != null ? Column(
                children: [
                  InkWell(
                    onTap: (){
                      showDialog(context: context, builder: (con) => Dialog(child: Container(height: 550, width: 600, child: HomeCategoryPopUp(
              ...
              ): CategoryAllShimmer(homecategoryController: homecategoryController)
            ],
          ),
...
class CategoryAllShimmer extends StatelessWidget {
  final HomeCategoryController categoryController;
  CategoryAllShimmer({@required this.categoryController, HomeCategoryController homecategoryController});
